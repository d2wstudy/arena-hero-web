import { Bot, Check, Copy, Crown, Eye, EyeOff, FlaskConical, LoaderCircle, ShieldCheck, UserPlus } from 'lucide-react'
...
export function GodModeConsole({
  ...
  const [busy, setBusy] = useState<'view' | 'vision' | 'participant' | null>(null)
